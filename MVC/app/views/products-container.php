        ...
        <div class="bg-white rounded-md overflow-hidden hover:shadow border transition-colors hover:border-P_blue">
            ...
            <div class="p-3">
                <a href="#" class="hover:text-gray-600 text-black font-thin">
                    ...
                    <div class=" flex gap-5 my-1 text-xl font-bold">
                        <p >$ 19.99</p>
                        <p class="text-red-400 line-through">$ 25.99</p>
                    </div>
                </a>
                <div class="flex h-10 justify-between items-center mt-4">
                    <button class="flex items-center justify-center bg-P_blue text-white rounded shadow-md transition-colors hover:bg-P_navy w-10 h-full">
                    ...
                    <button class="flex items-center capitalize bg-P_blue text-white py-2 px-3 rounded shadow-md transition-colors hover:bg-P_navy">
