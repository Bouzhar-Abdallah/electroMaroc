<!-- green -->
<div class="relative">
    <div id="alert-border-3" class="absolute w-full flex p-4 mb-4 bg-green-100 border-t-4 border-green-500 dark:bg-green-200" role="alert">
...
<div class="relative">
    <div id="alert-border-2" class="absolute w-full flex p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200" role="alert">
