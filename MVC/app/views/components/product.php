<div class="flex m-5">
    ...
    <div class="flex gap-3 flex-col w-120 h-fit border border-P_navy p-5">
        ...
        <div>
            ...
            <input class="border border-P_navy w-10" type="number" name="quantite" value="1" id="">
        </div>
        <div class="flex text-yellow-400">
            ...
            <p class="text-gray-600 pl-4">(45) Reviews</p>
        </div>


        <div class="flex gap-2 h-10 justify-between items-center mt-4">
            <button class="flex p-1 items-center justify-center bg-P_blue text-white rounded shadow-md transition-colors hover:bg-P_navy w-10 h-full">
            ...
            <button class="btn-primary w-3/4">Buy now</button>
        </div>
